    ...
    <div className="article-body">
      ...
      <nav className="article-toc">
        ...
        <ol className="toc-list">
          <li><a href="#cosa-sono">Cosa sono GitHub e Vercel (in parole semplici)</a></li>
          <li><a href="#perche-vercel">Perché usare Vercel al posto dell'hosting tradizionale</a></li>
          <li><a href="#passo-1">Passo 1 – Preparare i file del tuo sito</a></li>
          <li><a href="#passo-2">Passo 2 – Creare un account GitHub e caricare il sito</a></li>
          <li><a href="#passo-3">Passo 3 – Creare un account Vercel</a></li>
          <li><a href="#passo-4">Passo 4 – Importare il repository da GitHub a Vercel</a></li>
          <li><a href="#passo-5">Passo 5 – Deploy automatico a ogni modifica</a></li>
          <li><a href="#passo-6">Passo 6 – Collegare un tuo dominio personalizzato</a></li>
          <li><a href="#limiti-piano">Limiti del piano gratuito: quando basta e quando no</a></li>
          <li><a href="#conclusione">Conclusione: hosting gratuito sì, ma con qualità</a></li>
        </ol>
      </nav>

      <h2 id="cosa-sono">Cosa sono GitHub e Vercel (in parole semplici)</h2>
      ...
      <h2 id="perche-vercel">Perché usare Vercel al posto dell'hosting tradizionale</h2>
      ...
      <h2 id="passo-1">Passo 1 – Preparare i file del tuo sito</h2>
      ...
      <h2 id="passo-2">Passo 2 – Creare un account GitHub e caricare il sito</h2>
      <ol>
      ...
      <h2 id="passo-3">Passo 3 – Creare un account Vercel</h2>
      <ol>
      ...
      <h2 id="passo-4">Passo 4 – Importare il repository da GitHub a Vercel</h2>
      ...
      <h2 id="passo-5">Passo 5 – Deploy automatico a ogni modifica</h2>
      ...
      <h2 id="passo-6">Passo 6 – Collegare un tuo dominio personalizzato</h2>
      ...
      <h2 id="limiti-piano">Limiti del piano gratuito: quando basta e quando no</h2>
      ...
      <h2 id="conclusione">Conclusione: hosting gratuito sì, ma con qualità</h2>
