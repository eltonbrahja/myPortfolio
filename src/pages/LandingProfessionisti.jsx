...
import './LandingProfessionisti.css';

const LandingProfessionisti = () => {
    ...
    <PageTransition>
      <div className="landing-container">
        ...
        <nav className="landing-nav">
          ...
          <button className="landing-nav-cta ghost" onClick={scrollToForm}>
            Contatti
          </button>
        </nav>

        {/* 1. HERO */}
        <section className="landing-section hero-landing">
        ...
        {/* 8. FORM & WHATSAPP */}
        <section className="landing-section final-form-section" id="preventivo">
          ...
          <GlassCard className="landing-form">
            <form action="https://formspree.io/f/xpqwdgoa" method="POST" onSubmit={handleSubmit}>
              ...
              <div className="form-submit-container">
                <button type="submit" className="primary-btn landing-submit-btn" disabled={isSubmitting}>
        ...
        <footer className="landing-footer">
          <p>&copy; {new Date().getFullYear()} Elton Brahja. Tutti i diritti riservati.</p>
        </footer>
...
export default LandingProfessionisti;
